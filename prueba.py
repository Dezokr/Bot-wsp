...
def buscar_chats():
    ...
    if len(driver.find_elements_by_class_name("_zaKsw")) == 0:
        print("CHAT ABIERTO")
    ...
    for chat in chats:
        ...
        if len(chats_mensajes) == 0:
            ...
            continue
        #Caja de name chat
        element_name = chat.find_elements_by_class_name('_zoWT4')
...
def preparar_respuesta(message :str):
    ...
    if message.__contains__("QUE ES STRANGECODE"):
        ...
        response = "Hola, soy DZK, preguntame ¿Qué puedo hacer? :-D \n"
